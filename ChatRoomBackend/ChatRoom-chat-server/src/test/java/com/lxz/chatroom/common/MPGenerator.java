...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/ChatRoom-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/xizhenluo\">xizhenluo</a>");
        ...
        packageConfig.setParent("com.lxz.chatroom.common.user");//todo 自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("1251906353apTX!");
        dataSourceConfig.setUrl("jdbc:mysql://132.232.210.147/chatroom?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
