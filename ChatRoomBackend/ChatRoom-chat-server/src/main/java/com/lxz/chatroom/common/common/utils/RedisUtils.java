...
/**
 * use static methods instead of using Spring-management by @Component
 */
@Slf4j
public class RedisUtils {

    // save StringRedisTemplate as static variable when RedisUtils is first loaded
    ...
    } // using self-defining JsonUtils instead of hutools to avoid certain bugs
